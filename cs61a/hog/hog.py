...
def boar_brawl(player_score, opponent_score):
    ...
    points_scored = max(3 * abs(opponent_tens_digit - player_units_digit), 1)
...
def simple_update(num_rolls, player_score, opponent_score, dice=six_sided):
    ...
    """
    scorenumber = player_score + take_turn(num_rolls, player_score, opponent_score, dice)
    return scorenumber
...
def always_roll(n):
    ...
    3
    """
    assert 0 <= n <= 10, "n must be between 0 and 10"
